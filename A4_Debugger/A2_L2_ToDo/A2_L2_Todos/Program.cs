...
namespace Softwaredesign
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            getUserNumber();
            Console.WriteLine();
            Console.WriteLine(NumberToDifferentSystem(number, fromSystem, toSystem, isNumberDecimal(fromSystem)));
            Console.WriteLine();
        }
        ...
        static int NumberToDifferentSystem(int numberToConvert, int fromSystem, int toSystem, bool decimalNumber)
        {
            int result = 0;
            int factor = 1;
